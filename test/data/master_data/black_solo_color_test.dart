...
void main() {
  ...
  test(
    'solo black (no bonuses of its own) grants no attribute resistance when not SP',
    () async {
      ...
      expect(denpaMen.attributeResistance, isEmpty);
    },
  );

  test('solo black grants +1 to every attribute when SP', () async {
    final masterData = await JsonMasterDataRepository().load();
