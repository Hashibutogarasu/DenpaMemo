...
@useResult
$Res call({
 String id, String name, List<AbnormalityResistance> abnormalityResistances, List<String> bodyColors, List<int> bodyColorShades, List<AttributeResistance> attributeResistance, Physique physique, int? physiqueColumnIndex, Personality personality, Pattern pattern, HeadShape headShape, Anntena anntena, int antennaLevel, bool isSpColor, int happiness, int maxHappiness, int level, int maxLevel, int? currentExp, int? maxExp, int hp, int ap, int attack, int defense, int speed, int evasionRate, List<Correction> corrections, bool considerCorrections, AdditionalCorrection additionalCorrection, List<String> parentIds, int? catchOrder, String? qrCodeId, String? memo, DateTime? moveInDate, String hash, MonsterExp? monsterExp
});


$PhysiqueCopyWith<$Res> get physique;$PersonalityCopyWith<$Res> get personality;$PatternCopyWith<$Res> get pattern;$HeadShapeCopyWith<$Res> get headShape;$AnntenaCopyWith<$Res> get anntena;$AdditionalCorrectionCopyWith<$Res> get additionalCorrection;$MonsterExpCopyWith<$Res>? get monsterExp;
...
/// Create a copy of DenpaMen
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? name = null,Object? abnormalityResistances = null,Object? bodyColors = null,Object? bodyColorShades = null,Object? attributeResistance = null,Object? physique = null,Object? physiqueColumnIndex = freezed,Object? personality = null,Object? pattern = null,Object? headShape = null,Object? anntena = null,Object? antennaLevel = null,Object? isSpColor = null,Object? happiness = null,Object? maxHappiness = null,Object? level = null,Object? maxLevel = null,Object? currentExp = freezed,Object? maxExp = freezed,Object? hp = null,Object? ap = null,Object? attack = null,Object? defense = null,Object? speed = null,Object? evasionRate = null,Object? corrections = null,Object? considerCorrections = null,Object? additionalCorrection = null,Object? parentIds = null,Object? catchOrder = freezed,Object? qrCodeId = freezed,Object? memo = freezed,Object? moveInDate = freezed,Object? hash = null,Object? monsterExp = freezed,}) {
...
as bool,additionalCorrection: null == additionalCorrection ? _self.additionalCorrection : additionalCorrection // ignore: cast_nullable_to_non_nullable
as AdditionalCorrection,parentIds: null == parentIds ? _self.parentIds : parentIds // ignore: cast_nullable_to_non_nullable
...
@override
@pragma('vm:prefer-inline')
$AdditionalCorrectionCopyWith<$Res> get additionalCorrection {
  
  return $AdditionalCorrectionCopyWith<$Res>(_self.additionalCorrection, (value) {
    return _then(_self.copyWith(additionalCorrection: value));
  });
}/// Create a copy of DenpaMen
/// with the given fields replaced by the non-null parameter values.
@override
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String name,  List<AbnormalityResistance> abnormalityResistances,  List<String> bodyColors,  List<int> bodyColorShades,  List<AttributeResistance> attributeResistance,  Physique physique,  int? physiqueColumnIndex,  Personality personality,  Pattern pattern,  HeadShape headShape,  Anntena anntena,  int antennaLevel,  bool isSpColor,  int happiness,  int maxHappiness,  int level,  int maxLevel,  int? currentExp,  int? maxExp,  int hp,  int ap,  int attack,  int defense,  int speed,  int evasionRate,  List<Correction> corrections,  bool considerCorrections,  AdditionalCorrection additionalCorrection,  List<String> parentIds,  int? catchOrder,  String? qrCodeId,  String? memo,  DateTime? moveInDate,  String hash,  MonsterExp? monsterExp)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _DenpaMen() when $default != null:
return $default(_that.id,_that.name,_that.abnormalityResistances,_that.bodyColors,_that.bodyColorShades,_that.attributeResistance,_that.physique,_that.physiqueColumnIndex,_that.personality,_that.pattern,_that.headShape,_that.anntena,_that.antennaLevel,_that.isSpColor,_that.happiness,_that.maxHappiness,_that.level,_that.maxLevel,_that.currentExp,_that.maxExp,_that.hp,_that.ap,_that.attack,_that.defense,_that.speed,_that.evasionRate,_that.corrections,_that.considerCorrections,_that.additionalCorrection,_that.parentIds,_that.catchOrder,_that.qrCodeId,_that.memo,_that.moveInDate,_that.hash,_that.monsterExp);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String name,  List<AbnormalityResistance> abnormalityResistances,  List<String> bodyColors,  List<int> bodyColorShades,  List<AttributeResistance> attributeResistance,  Physique physique,  int? physiqueColumnIndex,  Personality personality,  Pattern pattern,  HeadShape headShape,  Anntena anntena,  int antennaLevel,  bool isSpColor,  int happiness,  int maxHappiness,  int level,  int maxLevel,  int? currentExp,  int? maxExp,  int hp,  int ap,  int attack,  int defense,  int speed,  int evasionRate,  List<Correction> corrections,  bool considerCorrections,  AdditionalCorrection additionalCorrection,  List<String> parentIds,  int? catchOrder,  String? qrCodeId,  String? memo,  DateTime? moveInDate,  String hash,  MonsterExp? monsterExp)  $default,) {final _that = this;
switch (_that) {
case _DenpaMen():
return $default(_that.id,_that.name,_that.abnormalityResistances,_that.bodyColors,_that.bodyColorShades,_that.attributeResistance,_that.physique,_that.physiqueColumnIndex,_that.personality,_that.pattern,_that.headShape,_that.anntena,_that.antennaLevel,_that.isSpColor,_that.happiness,_that.maxHappiness,_that.level,_that.maxLevel,_that.currentExp,_that.maxExp,_that.hp,_that.ap,_that.attack,_that.defense,_that.speed,_that.evasionRate,_that.corrections,_that.considerCorrections,_that.additionalCorrection,_that.parentIds,_that.catchOrder,_that.qrCodeId,_that.memo,_that.moveInDate,_that.hash,_that.monsterExp);case _:
  throw StateError('Unexpected subclass');
...
class _DenpaMen implements DenpaMen {
  const _DenpaMen({required this.id, required this.name, required final  List<AbnormalityResistance> abnormalityResistances, required final  List<String> bodyColors, final  List<int> bodyColorShades = const <int>[], required final  List<AttributeResistance> attributeResistance, required this.physique, this.physiqueColumnIndex, required this.personality, required this.pattern, required this.headShape, required this.anntena, this.antennaLevel = 0, required this.isSpColor, required this.happiness, required this.maxHappiness, required this.level, required this.maxLevel, required this.currentExp, required this.maxExp, required this.hp, required this.ap, required this.attack, required this.defense, required this.speed, required this.evasionRate, required final  List<Correction> corrections, required this.considerCorrections, this.additionalCorrection = const AdditionalCorrection(), required final  List<String> parentIds, this.catchOrder, this.qrCodeId, this.memo, this.moveInDate, this.hash = '', this.monsterExp}): _abnormalityResistances = abnormalityResistances,_bodyColors = bodyColors,_bodyColorShades = bodyColorShades,_attributeResistance = attributeResistance,_corrections = corrections,_parentIds = parentIds;
...
@override@JsonKey() final  AdditionalCorrection additionalCorrection;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _DenpaMen&&(identical(other.id, id) || other.id == id)&&(identical(other.name, name) || other.name == name)&&const DeepCollectionEquality().equals(other._abnormalityResistances, _abnormalityResistances)&&const DeepCollectionEquality().equals(other._bodyColors, _bodyColors)&&const DeepCollectionEquality().equals(other._bodyColorShades, _bodyColorShades)&&const DeepCollectionEquality().equals(other._attributeResistance, _attributeResistance)&&(identical(other.physique, physique) || other.physique == physique)&&(identical(other.physiqueColumnIndex, physiqueColumnIndex) || other.physiqueColumnIndex == physiqueColumnIndex)&&(identical(other.personality, personality) || other.personality == personality)&&(identical(other.pattern, pattern) || other.pattern == pattern)&&(identical(other.headShape, headShape) || other.headShape == headShape)&&(identical(other.anntena, anntena) || other.anntena == anntena)&&(identical(other.antennaLevel, antennaLevel) || other.antennaLevel == antennaLevel)&&(identical(other.isSpColor, isSpColor) || other.isSpColor == isSpColor)&&(identical(other.happiness, happiness) || other.happiness == happiness)&&(identical(other.maxHappiness, maxHappiness) || other.maxHappiness == maxHappiness)&&(identical(other.level, level) || other.level == level)&&(identical(other.maxLevel, maxLevel) || other.maxLevel == maxLevel)&&(identical(other.currentExp, currentExp) || other.currentExp == currentExp)&&(identical(other.maxExp, maxExp) || other.maxExp == maxExp)&&(identical(other.hp, hp) || other.hp == hp)&&(identical(other.ap, ap) || other.ap == ap)&&(identical(other.attack, attack) || other.attack == attack)&&(identical(other.defense, defense) || other.defense == defense)&&(identical(other.speed, speed) || other.speed == speed)&&(identical(other.evasionRate, evasionRate) || other.evasionRate == evasionRate)&&const DeepCollectionEquality().equals(other._corrections, _corrections)&&(identical(other.considerCorrections, considerCorrections) || other.considerCorrections == considerCorrections)&&(identical(other.additionalCorrection, additionalCorrection) || other.additionalCorrection == additionalCorrection)&&const DeepCollectionEquality().equals(other._parentIds, _parentIds)&&(identical(other.catchOrder, catchOrder) || other.catchOrder == catchOrder)&&(identical(other.qrCodeId, qrCodeId) || other.qrCodeId == qrCodeId)&&(identical(other.memo, memo) || other.memo == memo)&&(identical(other.moveInDate, moveInDate) || other.moveInDate == moveInDate)&&(identical(other.hash, hash) || other.hash == hash)&&(identical(other.monsterExp, monsterExp) || other.monsterExp == monsterExp));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,name,const DeepCollectionEquality().hash(_abnormalityResistances),const DeepCollectionEquality().hash(_bodyColors),const DeepCollectionEquality().hash(_bodyColorShades),const DeepCollectionEquality().hash(_attributeResistance),physique,physiqueColumnIndex,personality,pattern,headShape,anntena,antennaLevel,isSpColor,happiness,maxHappiness,level,maxLevel,currentExp,maxExp,hp,ap,attack,defense,speed,evasionRate,const DeepCollectionEquality().hash(_corrections),considerCorrections,additionalCorrection,const DeepCollectionEquality().hash(_parentIds),catchOrder,qrCodeId,memo,moveInDate,hash,monsterExp]);
...
@override $PhysiqueCopyWith<$Res> get physique;@override $PersonalityCopyWith<$Res> get personality;@override $PatternCopyWith<$Res> get pattern;@override $HeadShapeCopyWith<$Res> get headShape;@override $AnntenaCopyWith<$Res> get anntena;@override $AdditionalCorrectionCopyWith<$Res> get additionalCorrection;@override $MonsterExpCopyWith<$Res>? get monsterExp;
...
as List<Correction>,considerCorrections: null == considerCorrections ? _self.considerCorrections : considerCorrections // ignore: cast_nullable_to_non_nullable
as bool,additionalCorrection: null == additionalCorrection ? _self.additionalCorrection : additionalCorrection // ignore: cast_nullable_to_non_nullable
as AdditionalCorrection,parentIds: null == parentIds ? _self._parentIds : parentIds // ignore: cast_nullable_to_non_nullable
as List<String>,catchOrder: freezed == catchOrder ? _self.catchOrder : catchOrder // ignore: cast_nullable_to_non_nullable
as int?,qrCodeId: freezed == qrCodeId ? _self.qrCodeId : qrCodeId // ignore: cast_nullable_to_non_nullable
as String?,memo: freezed == memo ? _self.memo : memo // ignore: cast_nullable_to_non_nullable
as String?,moveInDate: freezed == moveInDate ? _self.moveInDate : moveInDate // ignore: cast_nullable_to_non_nullable
