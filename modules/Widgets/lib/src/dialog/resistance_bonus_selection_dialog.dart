...
/// "toggle, then adjust the selected ones" shape, including its per-entry
/// delete button. The name field sits above the scrollable list, at a fixed
/// position, so scrolling the list never moves it off-screen.
                      ...
                      if (_values.containsKey(option.id))
                        ListTile(
                          ...
                          subtitle: Slider(
                            ...
                            onChanged: (value) =>
                                _setValue(option.id, value.round()),
                          ),
                          trailing: IconButton(
                            icon: const Icon(Icons.close),
                            onPressed: () => _toggle(option.id),
                          ),
                        ),
                  ],
                ),
