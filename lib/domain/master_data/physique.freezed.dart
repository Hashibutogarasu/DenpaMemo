...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Physique&&(identical(other.id, id) || other.id == id));
}
...
class _Physique implements Physique {
  const _Physique({required this.id});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Physique&&(identical(other.id, id) || other.id == id));
}
