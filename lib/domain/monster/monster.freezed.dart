...
@JsonKey(name: 'translateKey') String get id;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Monster&&(identical(other.id, id) || other.id == id));
}
...
@useResult
$Res call({
@JsonKey(name: 'translateKey') String id
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(name: 'translateKey')  String id)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Monster() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(name: 'translateKey')  String id)  $default,) {final _that = this;
switch (_that) {
case _Monster():
return $default(_that.id);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@JsonKey(name: 'translateKey')  String id)?  $default,) {final _that = this;
switch (_that) {
case _Monster() when $default != null:
return $default(_that.id);case _:
  return null;
...
class _Monster implements Monster {
  const _Monster({@JsonKey(name: 'translateKey') required this.id});
  factory _Monster.fromJson(Map<String, dynamic> json) => _$MonsterFromJson(json);

@override@JsonKey(name: 'translateKey') final  String id;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Monster&&(identical(other.id, id) || other.id == id));
}
