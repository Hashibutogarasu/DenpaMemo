...
mixin _$DenpaMenSearchQuery {
 ...
 String get name; String? get headShapeId; List<String> get bodyColors; bool? get isSpColor; String get memo; int? get minHp; int? get minAp; int? get minAttack; int? get minDefense; int? get minSpeed; int? get minEvasionRate;
...
@override
int get hashCode => Object.hash(runtimeType,name,headShapeId,const DeepCollectionEquality().hash(bodyColors),isSpColor,memo,minHp,minAp,minAttack,minDefense,minSpeed,minEvasionRate);

@override
String toString() {
  return 'DenpaMenSearchQuery(name: $name, headShapeId: $headShapeId, bodyColors: $bodyColors, isSpColor: $isSpColor, memo: $memo, minHp: $minHp, minAp: $minAp, minAttack: $minAttack, minDefense: $minDefense, minSpeed: $minSpeed, minEvasionRate: $minEvasionRate)';
}
...
@useResult
$Res call({
 String name, String? headShapeId, List<String> bodyColors, bool? isSpColor, String memo, int? minHp, int? minAp, int? minAttack, int? minDefense, int? minSpeed, int? minEvasionRate
});
...
/// Create a copy of DenpaMenSearchQuery
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? name = null,Object? headShapeId = freezed,Object? bodyColors = null,Object? isSpColor = freezed,Object? memo = null,Object? minHp = freezed,Object? minAp = freezed,Object? minAttack = freezed,Object? minDefense = freezed,Object? minSpeed = freezed,Object? minEvasionRate = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String name,  String? headShapeId,  List<String> bodyColors,  bool? isSpColor,  String memo,  int? minHp,  int? minAp,  int? minAttack,  int? minDefense,  int? minSpeed,  int? minEvasionRate)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _DenpaMenSearchQuery() when $default != null:
return $default(_that.name,_that.headShapeId,_that.bodyColors,_that.isSpColor,_that.memo,_that.minHp,_that.minAp,_that.minAttack,_that.minDefense,_that.minSpeed,_that.minEvasionRate);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String name,  String? headShapeId,  List<String> bodyColors,  bool? isSpColor,  String memo,  int? minHp,  int? minAp,  int? minAttack,  int? minDefense,  int? minSpeed,  int? minEvasionRate)  $default,) {final _that = this;
switch (_that) {
case _DenpaMenSearchQuery():
return $default(_that.name,_that.headShapeId,_that.bodyColors,_that.isSpColor,_that.memo,_that.minHp,_that.minAp,_that.minAttack,_that.minDefense,_that.minSpeed,_that.minEvasionRate);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String name,  String? headShapeId,  List<String> bodyColors,  bool? isSpColor,  String memo,  int? minHp,  int? minAp,  int? minAttack,  int? minDefense,  int? minSpeed,  int? minEvasionRate)?  $default,) {final _that = this;
switch (_that) {
case _DenpaMenSearchQuery() when $default != null:
return $default(_that.name,_that.headShapeId,_that.bodyColors,_that.isSpColor,_that.memo,_that.minHp,_that.minAp,_that.minAttack,_that.minDefense,_that.minSpeed,_that.minEvasionRate);case _:
  return null;
...
class _DenpaMenSearchQuery extends DenpaMenSearchQuery {
  const _DenpaMenSearchQuery({this.name = '', this.headShapeId, final  List<String> bodyColors = const <String>[], this.isSpColor, this.memo = '', this.minHp, this.minAp, this.minAttack, this.minDefense, this.minSpeed, this.minEvasionRate}): _bodyColors = bodyColors,super._();
...
@override
int get hashCode => Object.hash(runtimeType,name,headShapeId,const DeepCollectionEquality().hash(_bodyColors),isSpColor,memo,minHp,minAp,minAttack,minDefense,minSpeed,minEvasionRate);
...
/// Create a copy of DenpaMenSearchQuery
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? name = null,Object? headShapeId = freezed,Object? bodyColors = null,Object? isSpColor = freezed,Object? memo = null,Object? minHp = freezed,Object? minAp = freezed,Object? minAttack = freezed,Object? minDefense = freezed,Object? minSpeed = freezed,Object? minEvasionRate = freezed,}) {
