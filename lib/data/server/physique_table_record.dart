...
/// position within the table identified by
/// `statusCategory`/`level`/`anntenaCategory`, and `values`' length must
/// match that status category's `columnCount` — see `PhysiqueTableEntity`
/// on the server.
@freezed
