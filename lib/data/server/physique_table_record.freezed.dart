...
mixin _$PhysiqueTableRecord {
 ...
 String get level; String get anntenaCategory; int get lineOffset; List<int> get values;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,level,anntenaCategory,lineOffset,const DeepCollectionEquality().hash(values));

@override
String toString() {
  return 'PhysiqueTableRecord(level: $level, anntenaCategory: $anntenaCategory, lineOffset: $lineOffset, values: $values)';
}
...
@useResult
$Res call({
 String level, String anntenaCategory, int lineOffset, List<int> values
});
...
/// Create a copy of PhysiqueTableRecord
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? level = null,Object? anntenaCategory = null,Object? lineOffset = null,Object? values = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String level,  String anntenaCategory,  int lineOffset,  List<int> values)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _PhysiqueTableRecord() when $default != null:
return $default(_that.level,_that.anntenaCategory,_that.lineOffset,_that.values);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String level,  String anntenaCategory,  int lineOffset,  List<int> values)  $default,) {final _that = this;
switch (_that) {
case _PhysiqueTableRecord():
return $default(_that.level,_that.anntenaCategory,_that.lineOffset,_that.values);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String level,  String anntenaCategory,  int lineOffset,  List<int> values)?  $default,) {final _that = this;
switch (_that) {
case _PhysiqueTableRecord() when $default != null:
return $default(_that.level,_that.anntenaCategory,_that.lineOffset,_that.values);case _:
  return null;
...
class _PhysiqueTableRecord implements PhysiqueTableRecord {
  const _PhysiqueTableRecord({required this.level, required this.anntenaCategory, required this.lineOffset, required final  List<int> values}): _values = values;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,level,anntenaCategory,lineOffset,const DeepCollectionEquality().hash(_values));
...
/// Create a copy of PhysiqueTableRecord
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? level = null,Object? anntenaCategory = null,Object? lineOffset = null,Object? values = null,}) {
