...
/// each call: a fresh [TranslationProvider]/[ProviderScope]/[MaterialApp]
/// on every call would tear down and reconstruct them each time, which can
/// orphan anything hosted in a separate part of the tree (e.g. an open
/// dialog's route) — losing its [TranslationProvider] ancestor, or never
/// closing at all.
