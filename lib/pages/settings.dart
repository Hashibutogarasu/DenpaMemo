    ...
    return AppScaffold(
      ...
      body: SettingsListContainer(
        children: [
          ...
          SettingsTile(icon: Icons.notifications_outlined, label: t.settings.notifications),
          SettingsTile(icon: Icons.tune_outlined, label: t.settings.advanced),
          SettingsTile(icon: Icons.bar_chart_outlined, label: t.settings.statistics),
          SettingsTile(
