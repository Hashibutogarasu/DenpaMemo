...
/// a maxed level/happiness gauge uses — or [AppColors.inactiveBonus] when
/// [active] is false, signaling the bonus isn't currently applied to the
/// preview. Must be a direct [Stack] child. Renders nothing when [value] is
/// zero.
